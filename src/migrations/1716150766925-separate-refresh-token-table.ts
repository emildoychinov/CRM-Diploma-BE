...
export class SeparateRefreshTokenTable1716150766925
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_refresh_token" ("id" SERIAL NOT NULL, "token" character varying, "user_id" integer, CONSTRAINT "UQ_cca1dbcca742456cf24913a0abf" UNIQUE ("token"), CONSTRAINT "REL_24e64309aedf1c04d857a456df" UNIQUE ("user_id"), CONSTRAINT "PK_2f86bb87603956e017efa2e74ec" PRIMARY KEY ("id"))`,
    );
